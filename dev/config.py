...
model_output_prefix = 'resnetMean_DateCut20' # Remember to modify the parameter below, this line is only about file naming
...
data_params = {
            'dir_train': {'d_class0': '/data/put_data/seanyu/ccp/clean_date_cut/thres20/non_copper_train/',
                                'd_class1': '/data/put_data/seanyu/ccp/clean_date_cut/thres20/copper_train/'
                 },
            # leave white space " " as value if there is no validation dir
            'dir_valid': {'d_class0': '',
                                'd_class1': ''
                 },
            'dir_test': {'d_class0': '/data/put_data/seanyu/ccp/clean_date_cut/thres20/non_copper_test/',
                               'd_class1': '/data/put_data/seanyu/ccp/clean_date_cut/thres20/copper_test/'
                 },
            'valid_ratio' : 0.1
        }
